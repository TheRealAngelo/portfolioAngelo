...
document.addEventListener('DOMContentLoaded', function() {
    const nav = document.querySelector('nav');
    const stickyBtns = document.getElementById('sticky-nav-btns');
    const loginForm = document.querySelector('.login-form');

    function isLoginFormInView() {
    ...
    function toggleNavAndBtns() {
        if (isLoginFormInView()) {
            nav.style.opacity = '0';
            nav.style.pointerEvents = 'none';
            if (stickyBtns) {
                stickyBtns.style.opacity = '0';
                stickyBtns.style.pointerEvents = 'none';
            }
        } else {
            nav.style.opacity = '1';
            ...
            if (stickyBtns) {
                ...
                stickyBtns.style.pointerEvents = '';
            }
        }
    }
